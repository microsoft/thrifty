...
class ThriftParserTest {
    ...
    @Test
    fun namespaces() {
        val thrift = "namespace java com.bendb.thrifty.parser\n" +
    ...
    fun includes() {
        ...
        val expected = ThriftFileElement(
                ...
                namespaces = listOf(
                        NamespaceElement(location.at(5, 1), NamespaceScope.ALL, "bendb")
                )
        )
    ...
    fun `jvm namespaces fall back to JVM declaration`() {
        val thrift = "namespace jvm com.bendb.thrifty.parser"
    ...
    fun `jvm namespaces fall back to JVM declaration but not if specified`() {
        val thrift = "namespace jvm com.bendb.thrifty.parser\nnamespace java com.bendb.thrifty.parser.java\n"
        ...
        val expected = ThriftFileElement(
            ...
            namespaces = listOf(
                ...
                NamespaceElement(
                    location = location.at(2, 1),
                    scope = NamespaceScope.JAVA,
                    namespace = "com.bendb.thrifty.parser.java"
                ),
                NamespaceElement(
                    location = location.at(1, 1),
                    scope = NamespaceScope.KOTLIN,
