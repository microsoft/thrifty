 ...
 */
fun ProcessedArgument<String, String>.path( // TODO: RawArgument is an internal typealias
...
fun RawOption.path(exists: Boolean = false,
                   ...
                   writable: Boolean = false,
                   readable: Boolean = false,
                   fileSystem: FileSystem = FileSystems.getDefault()): NullableOption<Path, Path> {
    val name = pathType(fileOkay, folderOkay)
