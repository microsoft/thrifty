...
public class Insanity implements org.apache.thrift.TBase<Insanity, Insanity._Fields>, java.io.Serializable, Cloneable, Comparable<Insanity> {
  ...
  public Insanity(Insanity other) {
    if (other.isSetUserMap()) {
      java.util.Map<Numberz,java.lang.Long> __this__userMap = new java.util.HashMap<Numberz,java.lang.Long>(other.userMap.size());
  ...
  public void putToUserMap(Numberz key, long val) {
    if (this.userMap == null) {
      this.userMap = new java.util.HashMap<Numberz,java.lang.Long>();
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.userMap = new java.util.HashMap<Numberz,java.lang.Long>(2*_map0.size);
                Numberz _key1;
                long _val2;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.userMap = new java.util.HashMap<Numberz,java.lang.Long>(2*_map11.size);
          Numberz _key12;
          long _val13;
