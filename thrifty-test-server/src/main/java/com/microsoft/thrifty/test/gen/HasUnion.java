...
public class HasUnion implements org.apache.thrift.TBase<HasUnion, HasUnion._Fields>, java.io.Serializable, Cloneable, Comparable<HasUnion> {
  ...
  public NonEmptyUnion TheUnion; // required
  ...
  public HasUnion setTheUnion(NonEmptyUnion TheUnion) {
    this.TheUnion = TheUnion;
    return this;
  }
  ...
  public int compareTo(HasUnion other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTheUnion()).compareTo(other.isSetTheUnion());
    if (lastComparison != 0) {
