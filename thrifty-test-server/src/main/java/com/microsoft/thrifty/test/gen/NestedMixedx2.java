...
public class NestedMixedx2 implements org.apache.thrift.TBase<NestedMixedx2, NestedMixedx2._Fields>, java.io.Serializable, Cloneable, Comparable<NestedMixedx2> {
  ...
  public java.util.List<java.util.Set<java.lang.Integer>> int_set_list; // required
  public java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> map_int_strset; // required
  public java.util.List<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>> map_int_strset_list; // required
  ...
  public NestedMixedx2 setInt_set_list(java.util.List<java.util.Set<java.lang.Integer>> int_set_list) {
    this.int_set_list = int_set_list;
    return this;
  }
  ...
  public NestedMixedx2 setMap_int_strset(java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> map_int_strset) {
    this.map_int_strset = map_int_strset;
    return this;
  }
  ...
  public NestedMixedx2 setMap_int_strset_list(java.util.List<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>> map_int_strset_list) {
    this.map_int_strset_list = map_int_strset_list;
    return this;
  }
  ...
  public int compareTo(NestedMixedx2 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInt_set_list()).compareTo(other.isSetInt_set_list());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMap_int_strset()).compareTo(other.isSetMap_int_strset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMap_int_strset()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMap_int_strset_list()).compareTo(other.isSetMap_int_strset_list());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMap_int_strset_list()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.Set<java.lang.Integer> _elem197;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                int _key203;
                java.util.Set<java.lang.String> _val204;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> _elem210;
                ...
                {
                  {
                    ...
                    int _key213;
                    java.util.Set<java.lang.String> _val214;
      ...
      if (incoming.get(0)) {
        {
          ...
          java.util.Set<java.lang.Integer> _elem234;
      ...
      if (incoming.get(1)) {
        {
          ...
          int _key240;
          java.util.Set<java.lang.String> _val241;
      ...
      if (incoming.get(2)) {
        {
          ...
          java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> _elem247;
          ...
          {
            {
              ...
              int _key250;
              java.util.Set<java.lang.String> _val251;
