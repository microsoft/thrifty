...
public class NestedListsI32x3 implements org.apache.thrift.TBase<NestedListsI32x3, NestedListsI32x3._Fields>, java.io.Serializable, Cloneable, Comparable<NestedListsI32x3> {
  ...
  public java.util.List<java.util.List<java.util.List<java.lang.Integer>>> integerlist; // required
  ...
  public NestedListsI32x3 setIntegerlist(java.util.List<java.util.List<java.util.List<java.lang.Integer>>> integerlist) {
    this.integerlist = integerlist;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.List<java.util.List<java.lang.Integer>> _elem173;
                ...
                {
                  {
                    ...
                    java.util.List<java.lang.Integer> _elem176;
      ...
      if (incoming.get(0)) {
        {
          ...
          java.util.List<java.util.List<java.lang.Integer>> _elem188;
          ...
          {
            {
              ...
              java.util.List<java.lang.Integer> _elem191;
