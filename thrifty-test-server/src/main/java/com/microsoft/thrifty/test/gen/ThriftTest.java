    ...
    public testInsanity_result(testInsanity_result other) {
      if (other.isSetSuccess()) {
        ...
        for (java.util.Map.Entry<java.lang.Long, java.util.Map<Numberz,Insanity>> other_element : other.success.entrySet()) {
          ...
          java.util.Map<Numberz,Insanity> __this__success_copy_value = new java.util.HashMap<Numberz,Insanity>(other_element_value.size());
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  for (int _i383 = 0; _i383 < _map380.size; ++_i383)
                  {
                    _key381 = iprot.readI64();
                    {
                      ...
                      _val382 = new java.util.HashMap<Numberz,Insanity>(2*_map384.size);
                      Numberz _key385;
                      Insanity _val386;
        ...
        if (incoming.get(0)) {
          {
            ...
            for (int _i395 = 0; _i395 < _map392.size; ++_i395)
            {
              _key393 = iprot.readI64();
              {
                ...
                _val394 = new java.util.HashMap<Numberz,Insanity>(2*_map396.size);
                Numberz _key397;
                Insanity _val398;
