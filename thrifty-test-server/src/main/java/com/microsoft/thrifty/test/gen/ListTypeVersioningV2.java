...
public class ListTypeVersioningV2 implements org.apache.thrift.TBase<ListTypeVersioningV2, ListTypeVersioningV2._Fields>, java.io.Serializable, Cloneable, Comparable<ListTypeVersioningV2> {
  ...
  public java.util.List<java.lang.String> strings; // required
  public java.lang.String hello; // required
  ...
  public ListTypeVersioningV2 setStrings(java.util.List<java.lang.String> strings) {
    this.strings = strings;
    return this;
  }
  ...
  public ListTypeVersioningV2 setHello(java.lang.String hello) {
    this.hello = hello;
    return this;
  }
  ...
  public int compareTo(ListTypeVersioningV2 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStrings()).compareTo(other.isSetStrings());
    if (lastComparison != 0) {
